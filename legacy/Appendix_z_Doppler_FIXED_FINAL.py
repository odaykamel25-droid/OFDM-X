...
def rayleigh_channel_ici(
    ...
    # ------------------------------------------------------
    # Fixed path gains for this channel realization
    # ------------------------------------------------------
    ...
    # Delays are within the CP.
    delays = np.arange(num_paths)

    # One Doppler frequency per path.
    ...
    # h[s,n,p] = path p at sample n of symbol s
    # ------------------------------------------------------
    ...
    # ------------------------------------------------------
    # Diagonal part of the time-varying OFDM channel.
    #
    # For subcarrier k:
    # H_kk is the average over the useful OFDM samples
    # of the instantaneous multipath frequency response.
    #
    # The off-diagonal terms are not equalized and therefore
    # remain as ICI.
    # ------------------------------------------------------
...
# ----------------------------------------------------------
# Fixed channel realization for all Eb/N0 points.
# ----------------------------------------------------------
