...
# ==========================================================
# TRUE VEHICULAR DOPPLER / ICI CHECK (same model used in Figure 11)
# ==========================================================
...
for eb in [0, 8, 12, 16, 20]:
    ...
    # The channel realization and the underlying noise
    # sequence are therefore reproducible across Eb/N0.
    np.random.seed(
        ICI_TEST_SEED
    )
